...
const Announcements = () => {
    return (
        <div className="rounded-2xl border border-white/10 bg-white/5 min-h-[400px] flex flex-col items-center justify-center text-gray-400 animate-in fade-in duration-300">
            ...
            <h3 className="text-xl font-bold text-white mb-2">Section Annonces en construction</h3>
            <p className="max-w-md text-center">
                L'interface pour la gestion des annonces et communications est en cours de développement.
            </p>
        </div>
    );
};
