...
const MoviePlayer = ({ movie: movieProp, onClose }: MoviePlayerProps) => {
  ...
  return (
    ...
    >
      ...
      {/* Contrôles */}
      <div className={`absolute bottom-0 left-0 right-0 transition-all duration-500 ease-in-out z-20 ${showControls ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-full'
        }`}>
